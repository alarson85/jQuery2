$(document).ready( function() {
	...
	if(localStorage['listo']){
		conosle.log('LOCALSTORAFE AT START;', localStorage['listo']);
	...
	var updateLocalStorage = function(){
		...
		console.log('LOCAL STORAGE at LISTO', localStorage['listo'];)
		localStorage['listo'] = listo;
		console.log('POST EDIT', localStorage['listo'];)
	}
